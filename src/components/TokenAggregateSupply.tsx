...
export const TokenAggregateSupply = () => {
  ...
  const chainSupplies = network.chains.map(chain => ({
    chainId: chain.id,
    ...
    <Card className="p-4">
      <div className="space-y-4">
        <div>
          ...
          <div className="text-2xl font-bold">{truncateDecimals(Number(formattedSupply), 6)}</div>
        </div>
        ...
        <div className="space-y-3">
          {chainSupplies.map(chain => {
            ...
            const percentage =
              Number(formattedSupply) > 0 ? (supply / Number(formattedSupply)) * 100 : 0;
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-center">
                      ...
                      <div className="text-right">
                        <div className="text-sm font-medium">{truncateDecimals(supply, 6)}</div>
